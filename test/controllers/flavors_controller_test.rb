...
class FlavorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flavor" do
    assert_difference('Flavor.count') do
      post flavors_url, params: { flavor: { active: @flavor.active, created_at: @flavor.created_at, name: @flavor.name, updated_at: @flavor.updated_at } }
    end
  ...
  test "should update flavor" do
    patch flavor_url(@flavor), params: { flavor: { active: @flavor.active, created_at: @flavor.created_at, name: @flavor.name, updated_at: @flavor.updated_at } }
